<template>
  <view class="container">
    ...
    <!--轮播图-->
    <u-swiper :list="swiperList" previousMargin="20" nextMargin="20" circular height="200"
    ...
    <!--消息滚动栏-->
    <u-notice-bar style="padding: 13px 12px" :text="noticeList" mode="link" direction="column" @click="click">
    </u-notice-bar>
          ...
          <view class="prod-item" v-for="(item, index) in productList" :key="item.id"
            ...
            <view class="item-info">
              <view class="info-text">
                <u--text :lines="2" size="14px" color="#333333" :text="item.title">98989</u--text>
              </view>
