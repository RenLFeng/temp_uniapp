 ...
 <image :src="pic"></image>
    <view class="auth-box">
      <view class="btn-group">
        <!-- #ifdef MP-WEIXIN -->
          <u-button class="auth-btn" open-type="getUserInfo" type="primary" @getuserinfo="getUserinfo">用户信息</u-button>
        ...
        <!-- #ifndef MP-WEIXIN -->
           <u-button type="primary" text="gdgd" @click="getUserinfo"></u-button>
...
export default {
  ...
  methods: {
    getUserinfo(e){
      console.log(e)
      // this.pic=e.detail.userInfo.avatarUrl
      uni.chooseImage()
    },
    getPhoneNumber(e) {
      console.log(e)
